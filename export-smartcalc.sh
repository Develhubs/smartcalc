...
EOL
    ...
    zip -r ../build/SmartCalc-static.zip .
    cd ..
    ...
    echo "Upload 'build/SmartCalc-static.zip' to your Hostinger public_html directory"
...
EOL
    ...
    zip -r ../build/SmartCalc-fullstack.zip .
    cd ..
    ...
    echo "Upload 'build/SmartCalc-fullstack.zip' to your Hostinger account"
    echo "For detailed instructions, see HOSTINGER_DEPLOYMENT.md"
